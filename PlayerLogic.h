...
public:
    ...
    */
    PlayerLogic();
    /**
     * @brief Moves Player x co-oridnate in a circular motion to the left. The circular movement keeps the same distance from the center of the screen.
     */
    void moveLeftX();
    /**
     * @brief Moves Player y co-oridnate in a circular motion to the left. The circular movement keeps the same distance from the center of the screen.
     */
    void moveLeftY();
    /**
     * @brief Moves Player x co-oridnate in a circular motion to the right. The circular movement keeps the same distance from the center of the screen.
     */
    void moveRightX();
    /**
     * @brief Moves Player y co-oridnate in a circular motion to the right. The circular movement keeps the same distance from the center of the screen.
     */
    void moveRightY();
    /**
     *  @brief Returns the angel of reotation of the player. The angle of rotation represents angular the step sizes at which the player rotates
     */
