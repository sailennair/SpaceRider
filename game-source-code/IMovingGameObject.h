...
public:
     ...
     *  All objects have a health this is simply a usefull model to determine if a movable object should be drawin in
     * screen.
    ...
    */
     ...
     * Although a  movable object is not necesserally circular a radius is defined from the center to the edges of the
     * object. This is usefull for collision detection.
