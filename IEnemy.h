...
/*! This class is responsible for been a role model class to Enemy ensuring that Enemy created adhere to a contract. This class inherits from ImovingGameObject
 ...
 * Although a  enemy is not necesserally circular a radius is defined from the center to the edges of the object. This is usefull for collision detection.
