...
LinkOptions            :=  
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch)C:\Users\User\Documents\SoftwareLab4\Lab_4\include 
IncludePCH             := 
RcIncludePath          := 
...
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)C:\Users\User\Documents\SoftwareLab4\Lab_4\lib 
...
$(IntermediateDirectory)/ExplosionPresentation.cpp$(ObjectSuffix): ExplosionPresentation.cpp $(IntermediateDirectory)/ExplosionPresentation.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/User/Documents/SoftwareDev2Project/SpaceRiderProject/ExplosionPresentation.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ExplosionPresentation.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/ExplosionPresentation.cpp$(DependSuffix): ExplosionPresentation.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/ExplosionPresentation.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/ExplosionPresentation.cpp$(DependSuffix) -MM ExplosionPresentation.cpp
